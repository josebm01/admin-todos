...
import { Product } from "@/products/interfaces/productos";

import { IoAddCircleOutline, IoRemove } from "react-icons/io5";
import { addSingleItemFromCart, removeSingleItemFromCart } from "../actions/actions";
...
export const ItemCard = ({ product, quantity }: Props) => {
  ...
  function onAddToCart() {
    addSingleItemFromCart(product.id);
    router.refresh();
  }
